...
import superCRM.dialog.MyTitleAreaDialog;
...
public class Application implements IPlatformRunnable {
	...
	public Object run(Object args) throws Exception {
		...
		/**验证成功后，创建住程序窗口*/
			...
			System.out.println("PlatformUI.RETURN_RESTART="+PlatformUI.RETURN_RESTART);
...
//			MyTitleAreaDialog window=new MyTitleAreaDialog(null);
